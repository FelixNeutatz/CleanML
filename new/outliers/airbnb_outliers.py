...
if __name__ == "__main__":
    target_label = 'Rating'
    drop_labels = []
    dirty_path = '/home/neutatz/Software/CleanML/data/Airbnb/outliers/dirty_train.csv'
    clean_path = '/home/neutatz/Software/CleanML/data/Airbnb/outliers/clean_HC_impute_holoclean_train.csv'
