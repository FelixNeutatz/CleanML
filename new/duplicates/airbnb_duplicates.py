...
if __name__ == "__main__":
    target_label = 'Rating'
    drop_labels = []
    dirty_path = '/home/neutatz/Software/CleanML/data/Airbnb/duplicates/dirty_train.csv'
    clean_path = '/home/neutatz/Software/CleanML/data/Airbnb/duplicates/clean_train.csv'
