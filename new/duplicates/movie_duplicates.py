...
if __name__ == "__main__":
    target_label = "genres"
    drop_labels = []
    dirty_path = '/home/neutatz/Software/CleanML/data/Movie/duplicates/dirty_train.csv'
    clean_path = '/home/neutatz/Software/CleanML/data/Movie/duplicates/clean_train.csv'
