...
if __name__ == "__main__":
    ...
    dirty_path = '/home/neutatz/Software/CleanML/data/Restaurant/duplicates/dirty_train.csv'
    clean_path = '/home/neutatz/Software/CleanML/data/Restaurant/duplicates/clean_train.csv'
