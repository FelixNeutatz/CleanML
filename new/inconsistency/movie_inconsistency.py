...
if __name__ == "__main__":
    target_label =  "genres"
    drop_labels = []
    dirty_path = '/home/neutatz/Software/CleanML/data/Movie/inconsistency/dirty_train.csv'
    clean_path = '/home/neutatz/Software/CleanML/data/Movie/inconsistency/clean_train.csv'
