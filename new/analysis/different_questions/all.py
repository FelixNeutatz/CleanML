...
def get_hyperparameter_values(mypath):
    ...
    check_components = ["'data_preprocessing:numerical_transformer:imputation:strategy': 'knn'",
                        ...
                        "'data_preprocessing:numerical_transformer:imputation:strategy': 'iterative'"
                        ]

    check_components = ["'data_preprocessing:categorical_transformer:imputation:strategy': 'knn'",
                        "'data_preprocessing:categorical_transformer:imputation:strategy': 'constant'",
                        "'data_preprocessing:categorical_transformer:imputation:strategy': 'most-frequent'"
                        ]

    '''
    check_components = ["'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection0': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection1': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection2': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection3': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection4': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection5': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection6': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection7': 'True'",
                        "'data_preprocessing:numerical_transformer:outlier_detection:detection:use_outlier_detection8': 'True'",
                        ]
    '''
