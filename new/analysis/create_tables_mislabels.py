...
def create_table(files, title):
    ...
    for file_name in files:
        try:
            p005_val_false = "/home/neutatz/data/cleanml_results/" + str(file_name) + "_p0.05_clean_val_False__dirty.p"
            p01_val_false = "/home/neutatz/data/cleanml_results/" + str(file_name) + "_p0.1_clean_val_False__dirty.p"
